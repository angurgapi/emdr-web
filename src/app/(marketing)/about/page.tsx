    ...
    <Container>
      <div className="py-10 ">
        ...
        <p className="mb-6">
          ...
          alternating movements or sounds are used to help the brain relax and
          process emotions more smoothly.
        </p>
        ...
        <p className="mb-4">
          Shapiro noticed that when people recalled upsetting memories while
          their eyes moved rapidly from side to side, the memories felt less
          distressing afterward. Over time, research confirmed that this kind of
          alternating stimulation can help the brain reprocess difficult
          emotions and restore a sense of calm.
        </p>
        ...
        <p className="mb-4">
          ...
          Bilateral stimulation seems to mimic that rhythm, allowing emotional
          and logical parts of the brain to communicate more efficiently.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          The truth is, many traumatized people don’t have easy access to
          therapy in general or EMDR in particular. Even when they do,
          practicing bilateral stimulation at home between sessions can enhance
          the therapeutic benefits. Our goal is to let you experience gentle
          bilateral stimulation without distractions, data tracking, payments or
          complicated setups. Use it to focus, relax, or simply give your mind a
          short break.
        </p>
